 ...
 */
public class GobiiTestConfiguration {

    private static Logger LOGGER = LoggerFactory.getLogger(GobiiTestConfiguration.class);
    ...
    public GobiiTestConfiguration() throws Exception {
