...
//            "target_js": "target//js",
                    ...
                    templateOptions: {
                        ...
                        templateOptions: {
                            requireConfig: {
                                ...
                                map: {
                                    '*': {
                                        '.gruntgrunt-contrib-jasminegrunt-template-jasmine-istanbul\reporter.js': '.grunt/grunt-contrib-jasmine/grunt-template-jasmine-istanbul/reporter.js'
                                    }
                                }
                            }
                        }
    ...
    // Default task(s).
    grunt.registerTask('default', ['clean', 'ts:dev', 'ts:compile_test', 'jasmine', 'uglify']);
    ...
    grunt.registerTask('test', ['ts:compile_test', , 'jasmine:run','jasmine']);
