...
public class UserInfoPrompter implements UserInfo, UIKeyboardInteractive {
  ...
  public boolean promptPassphrase(final String arg0) {
    Display.getDefault().syncExec(new Runnable() {
      public void run() {
        UserInfoPrompter.this.setPassword(new PasswordDialog(null).prompt(arg0));
      }
    });
    ...
    if ((this.getPassword() == null)
      ...
      Display.getDefault().syncExec(new Runnable() {
        public void run() {
          ...
          UserInfoPrompter.this.triedPassword = password;
          UserInfoPrompter.this.setPassword(password);
        }
      });
    }
