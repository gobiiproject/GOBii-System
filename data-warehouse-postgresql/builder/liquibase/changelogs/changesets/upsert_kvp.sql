...
--changeset kpalis:add_upsert_kvp_feature context:general splitStatements:false
...
DROP TYPE IF EXISTS distinct_source_keys;
CREATE TYPE distinct_source_keys AS (key text);
