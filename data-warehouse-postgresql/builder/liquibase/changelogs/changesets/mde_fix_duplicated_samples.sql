...
--changeset kpalis:fix_duplicated_samples_issue context:general splitStatements:false
...
RETURNS table (dnarun_name text
  ...
  BEGIN
	...
	select dr.name as dnarun_name
		...
		,(g.props->>getPropertyIdByNamesAndType('germplasm_prop','germplasm_seed_source_id',1)::text)
		...
		,(g.props->>getPropertyIdByNamesAndType('germplasm_prop','germplasm_par1',1)::text)
		,(g.props->>getPropertyIdByNamesAndType('germplasm_prop','germplasm_par2',1)::text)
		,(g.props->>getPropertyIdByNamesAndType('germplasm_prop','germplasm_par3',1)::text)
		,(g.props->>getPropertyIdByNamesAndType('germplasm_prop','germplasm_par4',1)::text)
		,(g.props->>getPropertyIdByNamesAndType('germplasm_prop','germplasm_pedigree',1)::text)
		,dns.name  as dnasample_name
		,dns.platename
		,dns.num
		,dns.well_row
		,dns.well_col	
		,(dns.props->>getPropertyIdByNamesAndType('dnasample_prop','dnasample_trial_name',1)::text)
		,(dns.props->>getPropertyIdByNamesAndType('dnasample_prop','dnasample_sample_group',1)::text)
		,(dns.props->>getPropertyIdByNamesAndType('dnasample_prop','dnasample_sample_group_cycle',1)::text)
		,(dns.props->>getPropertyIdByNamesAndType('dnasample_prop','dnasample_sample_type',1)::text)
		,(dns.props->>getPropertyIdByNamesAndType('dnasample_prop','dnasample_sample_parent',1)::text)
		,(dns.props->>getPropertyIdByNamesAndType('dnasample_prop','dnasample_ref_sample',1)::text)
	from dnarun dr
  ...
  BEGIN
	...
	from (
		select distinct on (dl.ds_id, dr.dataset_dnarun_idx->>dl.ds_id::text) 
			...
			,(g.props->>getPropertyIdByNamesAndType('germplasm_prop','germplasm_seed_source_id',1)::text) as gssd
			...
			,(g.props->>getPropertyIdByNamesAndType('germplasm_prop','germplasm_par1',1)::text) as gp1
			,(g.props->>getPropertyIdByNamesAndType('germplasm_prop','germplasm_par2',1)::text) as gp2
			,(g.props->>getPropertyIdByNamesAndType('germplasm_prop','germplasm_par3',1)::text) as gp3
			,(g.props->>getPropertyIdByNamesAndType('germplasm_prop','germplasm_par4',1)::text) as gp4
			,(g.props->>getPropertyIdByNamesAndType('germplasm_prop','germplasm_pedigree',1)::text) as gped
			,dns.name  as dnasample_name
			,dns.platename as plate
			,dns.num as dnum
			,dns.well_row as wr
			,dns.well_col as wc
			,(dns.props->>getPropertyIdByNamesAndType('dnasample_prop','dnasample_trial_name',1)::text) as dtn
			,(dns.props->>getPropertyIdByNamesAndType('dnasample_prop','dnasample_sample_group',1)::text) as dsg
			,(dns.props->>getPropertyIdByNamesAndType('dnasample_prop','dnasample_sample_group_cycle',1)::text) as dsgc
			,(dns.props->>getPropertyIdByNamesAndType('dnasample_prop','dnasample_sample_type',1)::text) as dst
			,(dns.props->>getPropertyIdByNamesAndType('dnasample_prop','dnasample_sample_parent',1)::text) as dsp
			,(dns.props->>getPropertyIdByNamesAndType('dnasample_prop','dnasample_ref_sample',1)::text) as drs
