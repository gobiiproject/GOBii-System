...
# setting dictionaries of acceptable allele representations   
    Alleles=dict([('A',1),('C',2),('G',3),('T',4),('N',5),('+',6),('-',7),('?',8),('0',9)])
# used for conversions of missing data to N
    MissingAlts=dict([('?',8),('0',9)])
    errCount=1
...
#If not in the dictionary errors are genrated                
                else:
                    if errCount<20:
                        sys.stderr.write(' Unsupported Allele Call row '+ str(count) + ' column '+ '1'+'\n')          
                        outString='N' + 'N'
                        errCount=errCount+1
                    else:
                ...
                while i <=nCol:
                    ...
                    if call[0] in Alleles and call[nChar-1] in Alleles:
                        ...
                        if errCount<20:
                            sys.stderr.write('Unsupported Allele Call row '+ str(count) + ' column '+ str(i)+'\n')          
